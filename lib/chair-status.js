...
export const CHAIR_STATUS_COLORS = {
  ...
  reserved: 'bg-muted/70 text-muted-foreground',
  occupied: 'bg-amber-50 text-amber-700 dark:bg-amber-950/30 dark:text-amber-300',
  cleaning: 'bg-amber-50 text-amber-700 dark:bg-amber-950/30 dark:text-amber-300',
  out_of_service: 'bg-red-50 text-red-700 dark:bg-red-950/30 dark:text-red-400',
}
