...
export const LAB_CASE_STATUS_META = {
  pending:       { label: 'Pending',            badge: 'bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-300' },
  sent:          { label: 'Sent to Lab',        badge: 'bg-blue-50 text-blue-700 dark:bg-blue-950/30 dark:text-blue-300' },
  lab_received:  { label: 'Received by Lab',     badge: 'bg-indigo-50 text-indigo-700 dark:bg-indigo-950/30 dark:text-indigo-300' },
  in_production: { label: 'In Production',        badge: 'bg-orange-50 text-orange-700 dark:bg-orange-950/30 dark:text-orange-300' },
  ready:         { label: 'Ready',              badge: 'bg-purple-50 text-purple-700 dark:bg-purple-950/30 dark:text-purple-300' },
  delivered:     { label: 'Delivered to Clinic', badge: 'bg-teal-50 text-teal-700 dark:bg-teal-950/30 dark:text-teal-300' },
  in_progress:   { label: 'In Progress',         badge: 'bg-orange-50 text-orange-700 dark:bg-orange-950/30 dark:text-orange-300' },
  received:      { label: 'Received',            badge: 'bg-teal-50 text-teal-700 dark:bg-teal-950/30 dark:text-teal-300' },
  approved:      { label: 'Design Approved',     badge: 'bg-green-50 text-green-700 dark:bg-green-950/30 dark:text-green-300' },
  revision_requested: { label: 'Revision Requested', badge: 'bg-amber-50 text-amber-700 dark:bg-amber-950/30 dark:text-amber-300' },
  completed:     { label: 'Completed',           badge: 'bg-green-50 text-green-700 dark:bg-green-950/30 dark:text-green-300' },
  cancelled:     { label: 'Cancelled',           badge: 'bg-red-50 text-red-600 dark:bg-red-950/30 dark:text-red-400' },
}
