...
// Legacy helper - use canAccessClinical from rbac instead
export const isReceptionist = p => p?.role === 'receptionist'
export const clinicalAccess = p => canAccessClinical(p?.role)
