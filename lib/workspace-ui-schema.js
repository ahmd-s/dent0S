...
export const EDITOR_TABS = [
  ...
  { id: 'communication_os_page', label: 'Communication OS' },
  { id: 'ai_os_page', label: 'AI OS' },
...
export const NAVIGATION_FIELDS = [
  ...
  { key: 'marketing', label: 'Communication' },
...
export const DASHBOARD_FIELDS = [
  ...
  // Sprint 17 — Communication OS widgets
  { key: 'comm_todays_reminders', label: "Today's Reminders" },
  { key: 'comm_birthdays', label: 'Birthdays (Comm)' },
  { key: 'comm_pending_followups', label: 'Pending Follow-ups (Comm)' },
  { key: 'comm_activity', label: 'Communication Activity' },
  { key: 'comm_campaign_performance', label: 'Campaign Performance' },
  { key: 'comm_review_requests', label: 'Review Requests' },
  { key: 'comm_outstanding_payments', label: 'Outstanding Payments (Comm)' },
  { key: 'comm_lab_notifications', label: 'Lab Notifications' },
  { key: 'comm_appointment_reminders', label: 'Appointment Reminders' },
  { key: 'comm_messages_sent', label: 'Messages Sent' },
  // Sprint 18 — AI OS widgets
  { key: 'ai_doctor_brief', label: 'Doctor Brief' },
  { key: 'ai_clinical_alerts', label: 'Clinical Alerts' },
  { key: 'ai_pending_drafts', label: 'Pending AI Drafts' },
  { key: 'ai_business_insights', label: 'Business Insights (AI)' },
  { key: 'ai_voice_queue', label: 'Voice Queue' },
  { key: 'ai_lab_insights', label: 'Lab Insights (AI)' },
  { key: 'ai_inventory_insights', label: 'Inventory Insights (AI)' },
  { key: 'ai_patient_risk', label: 'Patient Risk' },
  { key: 'ai_treatment_suggestions', label: 'Treatment Suggestions' },
  { key: 'ai_automation_queue', label: 'Automation Queue' },
]
...
/** Communication OS page configuration (Sprint 17). */
export const COMMUNICATION_OS_PAGE_FIELDS = [
  { key: 'communication_dashboard', label: 'Communication Dashboard' },
  { key: 'campaign_center', label: 'Campaign Center' },
  { key: 'review_panel', label: 'Review Panel' },
  { key: 'reminder_center', label: 'Reminder Center' },
  { key: 'communication_timeline', label: 'Communication Timeline' },
  { key: 'patient_segments', label: 'Patient Segments' },
  { key: 'quick_actions', label: 'Quick Actions' },
  { key: 'compact_mode', label: 'Compact Mode' },
]

/** AI OS page configuration (Sprint 18). */
export const AI_OS_PAGE_FIELDS = [
  { key: 'ai_dashboard', label: 'AI Dashboard' },
  { key: 'doctor_copilot', label: 'Doctor Copilot' },
  { key: 'clinical_assistant', label: 'Clinical Assistant' },
  { key: 'voice_assistant', label: 'Voice Assistant' },
  { key: 'prescription_assistant', label: 'Prescription Assistant' },
  { key: 'patient_education', label: 'Patient Education' },
  { key: 'recall_intelligence', label: 'Recall Intelligence' },
  { key: 'automation_panel', label: 'Automation Panel' },
  { key: 'quick_actions', label: 'Quick Actions' },
  { key: 'compact_mode', label: 'Compact Mode' },
]
