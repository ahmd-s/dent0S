...
export const AUDIT_ACTIONS = {
  ...
  WORKSPACE_TEMPLATES_UPDATED: 'workspace_templates_updated',
  WORKSPACE_TEMPLATES_RESET: 'workspace_templates_reset',
  WORKSPACE_CLINIC_UPDATED: 'workspace_clinic_updated',
  WORKSPACE_CLINIC_RESET: 'workspace_clinic_reset',
  // Sprint 9 — role experience
  WORKSPACE_ROLE_EXPERIENCE_UPDATED: 'workspace_role_experience_updated',
  WORKSPACE_ROLE_EXPERIENCE_RESET: 'workspace_role_experience_reset',
  WORKSPACE_PRESET_CHANGED: 'workspace_preset_changed',
  CLINIC_DEACTIVATED: 'clinic_deactivated',
  CLINIC_REACTIVATED: 'clinic_reactivated',
  CLINIC_PERMANENTLY_DELETED: 'clinic_permanently_deleted',
