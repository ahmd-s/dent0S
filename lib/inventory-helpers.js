...
export const STATUS_BADGE = {
  healthy: { label: 'In stock', className: 'text-muted-foreground bg-muted/70' },
  low_stock: { label: 'Low stock', className: 'text-amber-700 bg-amber-50 dark:text-amber-300 dark:bg-amber-950/30' },
  critical: { label: 'Critical', className: 'text-red-700 bg-red-50 dark:text-red-300 dark:bg-red-950/30' },
  expired: { label: 'Expired', className: 'text-red-700 bg-red-50 dark:text-red-300 dark:bg-red-950/30' },
  out_of_stock: { label: 'Out of stock', className: 'text-red-700 bg-red-50 dark:text-red-300 dark:bg-red-950/30' },
}
