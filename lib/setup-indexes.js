...
export const INDEX_SPEC = [
  ...
  { collection: 'clinics', keys: { is_active: 1, created_at: -1 } },
  { collection: 'clinics', keys: { deleted_at: 1 } },
  { collection: 'profiles', keys: { clinic_id: 1, last_login_at: -1 } },
  { collection: 'deleted_clinics', keys: { id: 1 } },
  ...
  { collection: 'clinic_sync', keys: { clinic_id: 1 }, options: { unique: true, name: 'clinic_sync_clinic_id' } },
  ...
  {
    collection: 'messages',
    keys: { provider_message_id: 1 },
    options: {
      unique: true,
      name: 'messages_provider_message_id',
