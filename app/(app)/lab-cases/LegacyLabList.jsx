...
const STATUS_FILTERS = [
  ...
  { value: 'impression_ready', label: 'Impression Ready' },
  { value: 'sent', label: 'Awaiting Lab Acceptance' },
  { value: 'lab_received,in_production,in_progress,quality_check', label: 'In Production' },
...
export default function LegacyLabList() {
  ...
  return (
    <div>
      ...
      <Card className="p-4 bg-card border-border rounded-lg flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
