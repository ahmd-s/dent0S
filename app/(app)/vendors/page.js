  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="flex items-center justify-between">
        ...
        {!receptionist && <Button onClick={openNew} className="bg-[#0D9488] hover:bg-[#0B7E73]"><Plus className="w-4 h-4 mr-1"/>Add Vendor</Button>}
      </div>
      ...
      {!loading && list.length === 0 && (
        <Card className="mt-4 bg-white border-border rounded-lg py-16 text-center text-muted-foreground text-sm">
          No vendors yet. {!receptionist && 'Add your first dental lab to start tracking cases.'}
        </Card>
      )}
      {!loading && list.length > 0 && (
