...
import { Loader2, Plus, Copy, ExternalLink, Trash2, Edit2, FileText, Check, LayoutGrid, Activity, Server, MessageCircle } from 'lucide-react'
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Cloud API credentials, webhook, and message templates</p>
            </div>
          </div>
          <span className="text-xs text-muted-foreground group-hover:text-foreground">Open →</span>
        </Link>
