...
import { Loader2, Plus, Copy, ExternalLink, Trash2, Edit2, FileText, CreditCard, Zap } from 'lucide-react'
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <Tabs defaultValue="clinic">
        <TabsList className="bg-[#F8FAFC]"><TabsTrigger value="clinic">Clinic Profile</TabsTrigger><TabsTrigger value="team">Team</TabsTrigger><TabsTrigger value="consent">Consent Forms</TabsTrigger><TabsTrigger value="subscription">Subscription</TabsTrigger></TabsList>
